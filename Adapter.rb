# Целевой класс объявляет интерфейс (клиентский интерфейс), с которым может работать клиентский код.
class Target
    # @return [String]
    def request 
...
# Адаптируемый класс (например сторонний сервис) содержит некоторое полезное поведение, но его интерфейс
